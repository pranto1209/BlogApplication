...
namespace BlogApplicationAPI.Repositories.Implementation;

public class CategoryRepository : ICategoryRepository
{
    private readonly BlogApplicationDbContext dbContext;

    public CategoryRepository(BlogApplicationDbContext dbContext)
    {
